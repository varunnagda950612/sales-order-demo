-- Parallel-write compatibility setup. Safe while the old app remains live.
-- It creates versioned v2 RPCs and additive schema only; legacy app writes remain enabled.
